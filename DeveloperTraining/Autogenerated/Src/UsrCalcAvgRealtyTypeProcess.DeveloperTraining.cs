namespace Terrasoft.Core.Process
{
	...
	#region Class: UsrCalcAvgRealtyTypeProcessMethodsWrapper

	/// <exclude/>
	public class UsrCalcAvgRealtyTypeProcessMethodsWrapper : ProcessModel
	{

		public UsrCalcAvgRealtyTypeProcessMethodsWrapper(Process process)
			: base(process) {
		...
		private bool ScriptTask1Execute(ProcessExecutingContext context) {
			var esq = new EntitySchemaQuery(UserConnection.EntitySchemaManager, "UsrRialty");
